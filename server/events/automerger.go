...
func (c *AutoMerger) automerge(ctx *command.Context, pullStatus models.PullStatus, deleteSourceBranchOnMerge, mergeWithSquash bool) {
	...
	pullOptions.MergeWithSquash = mergeWithSquash
